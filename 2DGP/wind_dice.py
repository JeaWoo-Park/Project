...
class Wind_Dice:
    ...
    def attack(self):
        if self.level == 1:
            bullet = Wind_Bullet(self.x + 2, self.y, self.attack_power)
            object.add_object(bullet, 1)
            pass
        elif self.level == 2:
            bullet = Wind_Bullet(self.x + 15 + 2, self.y + 15, self.attack_power)
            object.add_object(bullet, 1)
            bullet = Wind_Bullet(self.x - 15 + 2, self.y - 15, self.attack_power)
            object.add_object(bullet, 1)
            pass
            ...
            bullet = Wind_Bullet(self.x + 15 + 2, self.y - 15, self.attack_power)
            object.add_object(bullet, 1)
            bullet = Wind_Bullet(self.x - 15 + 2, self.y, self.attack_power)
            object.add_object(bullet, 1)
            bullet = Wind_Bullet(self.x + 15 + 2, self.y, self.attack_power)
            object.add_object(bullet, 1)
            pass
